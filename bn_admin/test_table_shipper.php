...
$sql = "SELECT * FROM `request_kyc` WHERE type_kyc = 'shipper'";
  ...
  <body>
        ...
        $num=0;
         while($row = $result->fetch_assoc()) { ?>
                ...
                <td><a class="btn btn-info" href="../pic/kyc/<?php echo $row["pic_booking_driver"]; ?> " role="button">ดูเลขป้ายทะเบียนรถ</a></td>
