...
.section1{
  background-image: url("../../../../Picture/oatmeal-with-different-berries-bowl-wooden-table_23-2148039679.jpg"); 

  height: 240px;
}
.section2{
  background-image: url("../../../../Picture/arisa1.png"); 

  height: 240px;
}

.section3{
  background-image: url("../../../../Picture/partner_1024x500px.jpg"); 
  background-position: center;
  background-size: cover;
  padding: 1.75em ;
  background-repeat: no-repeat;
